  ...
  return (
    <div className="fixed inset-0 bg-slate-50 flex items-center justify-center p-4 z-[200]">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-[3rem] shadow-2xl shadow-orange-100/50 overflow-hidden p-10 md:p-12 border border-orange-50">
          <div className="flex flex-col items-center mb-10 text-center">
            <div className="bg-orange-600 p-4 rounded-3xl shadow-xl shadow-orange-200 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  placeholder="admin"
                  className="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-[1.25rem] text-sm font-semibold outline-none focus:ring-2 focus:ring-orange-500/10 focus:border-orange-500 focus:bg-white transition-all"
                  value={username}
            ...
            <button
              ...
              type="submit"
              className="w-full bg-orange-600 hover:bg-orange-700 text-white py-5 rounded-[1.25rem] font-black text-xs uppercase tracking-[0.2em] transition-all shadow-xl shadow-orange-100 disabled:opacity-50 flex items-center justify-center gap-3 mt-4"
            >
              {isSubmitting ? (
