        ...
        <div className="fixed inset-0 z-[250] bg-slate-950/98 backdrop-blur-xl flex flex-col animate-in fade-in duration-200">
          ...
          <div className="flex items-center justify-between px-6 py-4 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-white/15 hover:bg-rose-500 border border-white/25 hover:border-rose-500 rounded-2xl text-white font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 shadow-lg"
