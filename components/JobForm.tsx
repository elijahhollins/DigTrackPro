      ...
      <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-xl overflow-hidden flex flex-col animate-in zoom-in duration-300 border border-slate-100">
        <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1.5">Project Management</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Base Address</label>
            <input 
              required 
              type="text" 
              className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-[1.25rem] text-sm font-semibold outline-none focus:ring-4 focus:ring-orange-100/50 focus:bg-white transition-all" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2 md:col-span-1">
              ...
              <input 
                ...
                type="text" 
                maxLength={2}
                className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-[1.25rem] text-sm font-semibold outline-none focus:ring-4 focus:ring-orange-100/50 focus:bg-white transition-all text-center uppercase" 
